...
Slowpoke::Slowpoke(ModuleGame* gameAt, b2Vec2 position) : MapObject(gameAt)
{
	...
	mapSlowpokeAnim.AddSprite(Sprite{ map_slowpoke,{0, 0}, {16,16} });
	mapSlowpokeAnim.AddSprite(Sprite{ map_slowpoke,{1, 0}, {16,16} });
...
{
	/*
	map_slowpoke_animator->Animate(50, 244, false);
